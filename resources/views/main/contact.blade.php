            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="o-contact-info text-left">
                        <h2>Contact Us</h2>
                        <div class="o-c-info">
                            <a href="mailto:support@hynetcapital.com">
                                <i class="icon-Envelope3"></i>support@hynetcapital.com
                            </a>
                        </div>
                        <div class="o-c-info">
                            <a href="tel:+380933562932">
                                <i class="icon-Mobile"></i>+3 809 3356 2932
                            </a>
                        </div>
                        <div class="o-c-info">
                            <a href="https://wa.me/+380933562932" target="_blank">
                                <i class="icon-Whatsapp"></i>whatsapp
                            </a>
                        </div>
                        <div class="o-c-info">
                            <i class="icon-Store3"></i>Ap #867-859 Sit Rd, Azusa
                            <br>New York 39531</div>
                        <a href="#" class="btn btn-small">
                            <i class="icon-Store"></i>VIEW MAP</a>
